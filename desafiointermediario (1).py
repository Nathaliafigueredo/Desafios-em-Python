...
x1, y1, x2, y2 = map(int, input("Digite as coordenadas (x1 y1 x2 y2):").split())

resultado = movimentos(x1, y1, x2, y2)

print("O menor número de movimentos necessários é", resultado)
